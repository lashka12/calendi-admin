...
export default function CalendarPage() {
  ...
  const initialDate = searchParams.get('date') || formatDateString(new Date());
        ...
        {isModalOpen && editedAppointment && (
          <>
            ...
            <motion.div
              ...
              onClick={closeModal}
              onTouchMove={(e) => e.preventDefault()}
              className="fixed -top-20 -left-4 -right-4 -bottom-20 bg-black/50 z-[9999] touch-none overscroll-contain"
            />
